...
namespace BcaEttv
{
  ...
  EttvSurface : GH_Component
  {
    ...
    protected override void RegisterInputParams(GH_Component.GH_InputParamManager pManager)
    {
      ...
      pManager.AddPlaneParameter("Surface", "S", "Envelope Surface", GH_ParamAccess.list);
      pManager.AddNumberParameter("EttvConstruction", "c", "EttvConstruction Output generated by EttvConstruction component", GH_ParamAccess.item);
    ...
    protected override System.Drawing.Bitmap Icon
    {
      get
      {
        ...
        using var stream = assembly.GetManifestResourceStream("BcaEttv.Icons.EttvSurface.png");
    ...
    /// </summary>
    public override Guid ComponentGuid => new Guid("fd02f4aa-ae14-492b-8856-105fe5109202");
  }
}